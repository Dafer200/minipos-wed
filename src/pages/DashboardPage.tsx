...
import ProductsLineChart from "../charts/ProductsLineChart";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border p-4 shadow-sm lg:col-span-2">
          <h2 className="text-xl font-semibold mb-4">
            Nuevas entradas de productos
          </h2>
          <ProductsLineChart />
        </div>
      </div>
